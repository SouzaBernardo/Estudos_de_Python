...
print(f'{cores["verde"]}Olá! Escolha um número inteiro e vamos converter suas bases.{cores["limpo"]}')
...
if escolha_da_base == 1:
    ...
    print(f'Convertemos seu número para {cores["verde"]}BINÁRIO{cores["limpo"]}!')
    ...
    # add time.sleep
    print(f'{cores["verde"]}...{cores["limpo"]}')
