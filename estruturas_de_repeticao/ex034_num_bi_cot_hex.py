...
print(linha)
print(f'{cores["verde"]}Olá! Escolha um {cores["amarelo"]}número inteiro{cores["verde"]} e vamos converter suas bases.{cores["limpo"]}')
numero_escolhido = int(input(f'{cores["amarelo"]}Digite o número:'))
print(linha)
