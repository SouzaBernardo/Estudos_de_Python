...
if escolha_da_base == 1:
    ...
    print('Convertemos seu número para \033[32mBINÁRIO\033[m!') # Indicar a operação desejada
    # Indicar resposta
    ...
    print('\033[32mANALISANDO...\033[m')
    print('Convertemos seu número para \033[32mOCTAL\033[m!') # Indicar a operação desejada
    # Indicar resposta
    ...
    print('\033[32mANALISANDO...\033[m')
    print('Convertemos seu número para \033[32mHexadecimal\033[m!') # Indicar a operação desejada
    # Indicar resposta
